...
{ 
    ...
    {        
        ...
        // Fetch only CAA Staff from the database
        $personnels = $searchQuery
            ->whereIn('user_type', User::UserTypes)
            ->where('user_type', 'CAA Staff')  // only CAA Staff
            ->orderBy('created_at', 'desc')
            ->paginate(50);

        return Inertia::render('Officers/List', [
    ...
    public function show(string $id)
    {
        ...
        return Inertia::render('Officers/Show', [
            ...
            'specialisedtraining' => $specialisedtraining, // check this exact spelling!
        ]);        
    }
