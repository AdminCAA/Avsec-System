...
<head>
    <meta charset="UTF-8">
    <title>Registration of New User Account</title>
    <style>
        body {
...
<body>
    ...
    <p>Dear Admin,</p>
    <p>A new user account has been created on the AVSEC sytem. Kindly  login to review the registered user and assign appropriate user role.</p>
