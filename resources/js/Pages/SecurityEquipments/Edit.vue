                               ...
                               <div class="row">
                                    ...
                                    <div class="form-group col-md-12">                                    
                                      ...
                                      <v-select 
                                            ...
                                            label="name"
                                            placeholder="-- Select Location / Facility --"
                                            :input-class="{
              ...
              <div class="card-body">
                <div class="row">
                                    <div class="form-group d-flex justify-content-end col-md-12">
                                        <Link :href="route('security-equipments.createSchedule',securityEquipment.id)" class="btn btn-info">
                ...
                <table v-if="maintainanceSchedules.length > 0"  id="example2" class="table table-sm table-bordered table-hover table-striped">
                  <thead>
                  <tr>
                    <th>#</th>
                    <th>L/M.Date</th>
