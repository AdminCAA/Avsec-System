...
const {
    trainings,user_id,certification
} = defineProps({
...
function updateCertification() {
    ...
    axios.post(route('certifications.update', certification.id), formData)
    .then(response => {
        Swal.fire({
            icon: "success",
            title: "Certification update successfully",
            toast: true,
            position: "top-end",
...
<template>
    ...
    <div class="content-wrapper">    
        ...
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h3 class="m-0">Certification / Edit</h3>
            </div>
            <div class="col-sm-6">
                ...
                <div class="col-md-12"> 
                    <div class="col-md-12">                    
                        ...
                        <div class="card card-info">
                            ...
                            <!-- form start -->
                            <form @submit.prevent="updateCertification" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                <div class="row">
