...
const form = useForm({
    ...
    user_id: '',
    user_name: '',
    selected_checklist_question_id: followup.selected_checklist_question_id,  
    followup_comments: followup.followup_comments || '',
...
function updateFollowupControl() {
  isLoading.value = true;  
  axios.post(route('followups.update',followup.id), form)
    .then(() => {
      Swal.fire({
        icon: 'success',
      ...
      setTimeout(() => {
        router.visit(route('securityconcerns.edit', followup.selected_checklist_question_id), {
          preserveScroll: true,
          replace: true
        });
      }, 1500);
                ...
                <div class="col-md-10 mb-4">                    
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Edit Follow up</h3>
                        </div>
                        <!-- form start -->                        
                        <form @submit.prevent="updateFollowupControl">
                            <div class="card-body">
                              <!-- Name -->
                               <!-- Row 1: Name & Category -->
                                <div class="row">
                            ...
                            <div class="card-footer d-flex justify-content-end">
                              ...
                              <Link :href="route('securityconcerns.edit',followup.selected_checklist_question_id)" class="btn btn-secondary">
