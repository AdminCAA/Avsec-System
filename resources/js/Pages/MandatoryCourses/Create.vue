...
function createMandatoryCourse() {
  ...
  axios.post(route('mandatorycourses.store'), formData)
    .then(() => {
      Swal.fire({
        icon: 'success',
        title: 'Mandatory course added successfully',
        toast: true,
        position: 'top-end',
      ...
      setTimeout(() => {
        router.visit(
          route('officers.show', personnel.id) + '?tab=Mandatory+Course',
          { replace: true }
        );
      }, 1200);
...
<template>
  ...
  <Head title="Add Mandatory Course" />
  <AuthenticatedLayout>
    <div class="content-wrapper">
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h3 class="m-0"><strong>Mandatory Course / Create</strong></h3>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-md-10">
              <div class="card card-info">
                <div class="card-header">
                  <h3 class="card-title">Add Mandatory Course</h3>
                </div>
                <form @submit.prevent="createMandatoryCourse" enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="row">
                      <div class="form-group col-md-6">
                        <label>Course Name</label>
                        <input type="text" v-model="form.course_name" class="form-control"
                          :class="{ 'is-invalid': formErrors.course_name }" placeholder="Enter course name">
                  ...
                  <div class="card-footer text-right">
                    ...
                    <Link :href="route('officers.show', personnel.id)" class="btn btn-default ml-2">
