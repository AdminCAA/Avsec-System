...
const form = useForm({
    ...
    password: "",
    confirm_password: "",
    portrait: null // Initialize portrait as null
});

const isLoading = ref(false);
//Create the user permission
// and redirect to the permissions index page
// const selectedTrainings = ref({}); // This will hold the selected permission IDs
...
function createUser() {
    ...
    formData.append('facility_id', form.facility_id); // Use the selected facility ID
    formData.append('phone_number', form.phone_number);
    formData.append('user_type', form.user_type);
    formData.append('is_certified', form.is_certified); // Use the selected status
    ...
    axios.post(route('officers.store'), formData)
        .then(response => {
            Swal.fire({
                icon: "success",
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h3 class="m-0">Avsec Officer / Create</h3>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item">
                                    <Link class="btn btn-info mr-3" :href="route('officers.create')"><i
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <select required v-model="form.gender" class="form-control"
                                                            ...
                                                            <option v-for="item in genderOptions" :key="item"
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input v-model="form.password" type="password"
                                                            class="form-control" id="password" required max="255"
                                                            :class="{
                                                                'is-invalid': formErrors.password,
                                                                'is-valid': form.password && !formErrors.password
                                                            }" placeholder="Enter Password">
                                                        <InputError
                                                            :message="formErrors.password || form.errors.password"
                                                            class="mt-2" />
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input v-model="form.confirm_password" type="password"
                                                            class="form-control" id="paswword_confirmation" required
                                                            max="255" :class="{
