...
let trainingsUrl = computed(() => {
  let url = new URL(route('trainings.index'));
...
watch(() => trainingsUrl.value, (newUrl) => {
  router.visit(newUrl, {
    preserveScroll: true,
    preserveState: true,
    replace: true
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item">
                  <Link class="btn btn-info" :href="route('trainings.create')"><i class="fas fa-plus"></i> Create</Link>
                </li>
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <table v-if="trainings.data.length > 0" id="example2"
                  ...
                  <div v-if="trainings.data.length > 0" class="card mt-3">
                    <Pagination :data="trainings" :updatePageNumber="updatePageNumber" />
                  </div>
                  <div v-else class="card mt-3">
                    <h3 class="text-center">No trainings found</h3>
                    <p class="text-center">Please create a training to get started.</p>
                  </div>
