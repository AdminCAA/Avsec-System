...
function createQualification() {
    ...
    axios.post(route('qualifications.store', user_id), formData)
    .then(response => {
        Swal.fire({
            icon: "success",
...
<template>
    ...
    <div class="content-wrapper">    
        ...
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h3 class="m-0">Qualification / Create</h3>
            </div>
            <div class="col-sm-6">
                ...
                <div class="col-md-12"> 
                    <div class="col-md-12">                    
                        ...
                        <div class="card card-info">
                            ...
                            <!-- form start -->
                            <form @submit.prevent="createQualification" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                <div class="row">
