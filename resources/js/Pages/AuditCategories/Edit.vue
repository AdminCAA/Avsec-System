        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h3 class="m-0"><strong>Audit Area / Edit</strong></h3>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item">
                                    <Link class="btn btn-info" :href="route('audit-categories.index')"><i
                                    ...
                                    <form @submit.prevent="editAuditAreaCategory">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div v-if="form.category_name && !formErrors.category_name"
                                                    class="valid-feedback d-block">
                                        ...
                                        <div class="card-footer">
                                            <div class="d-flex ">
                                                ...
                                                <Link :href="route('audit-categories.index')"
