    ...
    <div class="content-wrapper">
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h3 class="m-0"><strong>Quality Control Questions</strong></h3>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item">
                  <Link class="btn btn-info" :href="route('audit-questions.create')"><i class="fas fa-plus"></i> Create
                  </Link>
                </li>
              </ol>
            </div>
              ...
              <div class="card">
                <div class="card-body">
                      ...
                      <div class="form-group">
                        <div class="input-group input-group-sm">
                          <input type="search" class="form-control form-control-lg"
                            placeholder="Search for audit question here.." v-model="search">
                  ...
                  <div class="table-responsive">
                    ...
                    <table v-if="auditQuestions.data.length > 0" id="example2"
                  ...
                  <div v-else class="card mt-3">
                    ...
                    <p>Please create a question to get started.</p>
                  </div>
                </div>
              </div>
            </div>
