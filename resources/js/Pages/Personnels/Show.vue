              ...
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item">
                  <Link class="btn btn-info" data-bs-toggle="tooltip" title="Edit"
                    :href="route('personnels.edit',personnel.id)"><i class="fas fa-edit"></i> Edit</Link>
                </li>
                <li class="breadcrumb-item">
                  <Link class="btn btn-info" data-bs-toggle="tooltip" title="Back to Personnels"
                    :href="route('personnels.index')"><i class="fas fa-arrow-left"></i> Back</Link>
                </li>
              </ol>
            </div>
          </div>
                  ...
                  <div class="card-header p-2">
                    <ul class="nav nav-pills">
                      <li class="nav-item"><a class="nav-link active" href="#certifications" data-toggle="tab"><i
                            class="fas fa-shield-alt"></i> Certifications</a></li>
                      <li class="nav-item"><a class="nav-link" href="#qualifications" data-toggle="tab"><i
                            class="fas fa-user-graduate"></i> Qualifications</a></li>
                    </ul>
                  </div><!-- /.card-header -->
                  <div class="card-body">
