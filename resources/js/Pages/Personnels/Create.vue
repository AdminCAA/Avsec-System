...
function createUser() {
    ...
    axios.post(route('personnels.store'), formData)
    .then(response => {
        Swal.fire({
            icon: "success",
        ...
        setTimeout(() => {            
            router.visit(route('personnels.index'), {
                preserveScroll: true,
                replace: true
            }); 
        }, 1000);        
        ...
        <div class="container-fluid">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><Link class="btn btn-info mr-3" :href="route('personnels.index')"><i class="fas fa-arrow-left"></i> Back</Link></li>
                </ol>
            </div>
            </div>
        </div>
                            ...
                            <form @submit.prevent="createUser" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        >
                                            ...
                                            <option v-for="item in userTypes" :key="item" :value="item">{{ item }}</option>
                                        </select>
                                ...
                                <div class="card-footer">
                                    <div class="d-flex ">                                
                                        ...
                                        <Link :href="route('personnels.index')" class="btn btn-default float-right">
