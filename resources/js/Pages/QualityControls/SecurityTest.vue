...
let qualityControlsUrl = computed(() => {
  let url = new URL(route('quality-controls.listSecurityTests'));
...
const updatePageNumber = (link) => {
  ...
  router.visit("/quality-controls.listSecurityTests?page=" + pageNumber.value, {
    preserveScroll: true,
  });
      ...
      if (result.isConfirmed) {
        axios.delete(route('quality-controls.destroy', id), { data: {} })
          .then(response => {
            ...
            setTimeout(() => {
              router.visit(route('quality-controls.listSecurityTests'), {
                preserveScroll: true,
                replace: true
              });
            }, 1000);
    ...
    <div class="content-wrapper">
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h3 class="m-0"><strong>Quality Controls - Security Tests</strong></h3>
            </div>
            <div class="col-sm-6">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="row mb-3 align-items-center justify-content-between">
                    ...
                    <div class="col-md-9 d-flex justify-content-end align-items-center" style="gap: 30px;">
