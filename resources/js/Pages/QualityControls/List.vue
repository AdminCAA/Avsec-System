    ...
    <div class="content-wrapper">
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h3 class="m-0"><strong>Quality Control Activities</strong></h3>
            </div>
            <div class="col-sm-6">
...
=======
                    ...
                    <div class="col-md-8 d-flex justify-content-end gap-4">
                      <div class="form-group d-flex align-items-center gap-2 mb-0">
                        <p class="mb-0" style="white-space: nowrap;"><strong>Start Date</strong></p>
                        <input type="date" class="form-control form-control-sm" v-model="startDate">
>>>>>>> 38f8373b61a9793faa640ae28cb592a362ddca11
                      </div>

                      <div class="form-group d-flex align-items-center gap-2 mb-0">
                        <p class="mb-0" style="white-space: nowrap;"><strong>End Date</strong></p>
