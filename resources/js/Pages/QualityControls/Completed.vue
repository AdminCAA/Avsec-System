...
let qualityControlsUrl = computed(() => {
  let url = new URL(route('quality-controls.listCompleted'));
...
const updatePageNumber = (link) => {
  ...
  router.visit("/quality-controls?page=" + pageNumber.value, {
    preserveScroll: true,
  });
    ...
    <div class="content-wrapper">
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h3 class="m-0"><strong>Quality Controls - Completed</strong></h3>
            </div>
            <div class="col-sm-6">
