    ...
    <div class="content-wrapper">
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h3 class="m-0"><strong>Quality Control / Create</strong></h3>
            </div>
          </div>
        </div>
      </div>
                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <select required v-model="form.control_type" class="form-control"
                            ...
                            <option v-for="item in props.qualityControlTypes" :key="item" :value="item">{{ item }}
                            </option>
                          </select>
                      ...
                      <div class="row">
                        <div class="form-group col-md-6">
                          ...
                          <v-select v-model="form.facility_id" :options="props.facilities"
                            :reduce="facility => facility.id" label="name" placeholder="-- Select Operator --" :class="{
                      ...
                      <div class="row">
                        <div class="form-group col-md-6">
                          ...
                          <input required v-model="form.scheduled_date" :min="today" type="date" class="form-control"
                            :class="{
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input required v-model="form.end_date" :min="today" type="date" class="form-control" :class="{
