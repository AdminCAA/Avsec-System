...
let qualityControlsUrl = computed(() => {
  let url = new URL(route('quality-controls.listAudits'));
...
const updatePageNumber = (link) => {
  ...
  router.visit("/quality-controls.listAudits?page=" + pageNumber.value, {
    preserveScroll: true,
  });
}
      ...
      if (result.isConfirmed) {
        axios.delete(route('quality-controls.destroy', id), { data: {} })
          .then(response => {
            ...
            setTimeout(() => {
              router.visit(route('quality-controls.listAudits'), {
                preserveScroll: true,
                replace: true
              });
            }, 1000);
    ...
    <div class="content-wrapper">
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h3 class="m-0"><strong>Quality Controls - Audits</strong></h3>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item">
                  <Link class="btn btn-info" :href="route('quality-controls.create')"><i class="fas fa-plus"></i> Create
                  </Link>
                </li>
              </ol>
            </div>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="row mb-3 align-items-center justify-content-between">
                      ...
                      <div class="form-group mb-0">
                        <div class="input-group input-group-sm">
                          <input type="search" class="form-control form-control-lg"
                            placeholder="Search for Quality Control Here..." v-model="search">
                          <div class="input-group-append">
                            <button type="submit" class="btn btn-lg btn-default">
                              <i class="fa fa-search"></i>
                            </button>
                    ...
                    <!-- Start & End Dates (Right Side) -->
                    <div class="col-md-8 d-flex justify-content-end align-items-center" style="gap: 30px;">
                      <div class="form-group d-flex align-items-center mb-0" style="gap: 10px; min-width: 260px;">
                        <p class="mb-0"><strong>Start Date</strong></p>
                        <input type="date" class="form-control form-control-sm" v-model="startDate" style="flex: 1;">
                      </div>

                      <div class="form-group d-flex align-items-center mb-0" style="gap: 10px; min-width: 260px;">
                        <p class="mb-0"><strong>End Date</strong></p>
                        <input type="date" class="form-control form-control-sm" v-model="endDate" style="flex: 1;">
                      </div>
                    </div>
                  </div>

                  <div class="table-responsive">
                    <table v-if="qualityControls.data.length > 0" id="example2"
                      ...
                      <tbody>
                        <tr v-for="(item, index) in sortedQualityControls" :key="item.id"
                          ...
                          <td class="d-none d-lg-table-cell">
                            <span v-for="user in item.users" :key="user.id" class="user-badge mr-1 mb-1">
                              {{ user.name }}
                            </span>
                          </td>
                          ...
                          <td class="d-lg-none">
                            <div class="d-flex">
                              <div v-for="(user, index) in item.users" :key="user.id"
                          ...
                          <td>
                            <Link v-if="item.selected_checklist_questions?.length > 0 && item.users?.length > 0"
                              class="btn btn-success btn-sm mr-2" :href="route('quality-controls.show', item.id)">
                  ...
                  <div v-else class="card mt-3">
                    <h3 class="mt-3">No item found</h3>
