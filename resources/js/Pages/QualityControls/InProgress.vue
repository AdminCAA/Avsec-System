...
let qualityControlsUrl = computed(() => {
  let url = new URL(route('quality-controls.listInProgress'));
...
const updatePageNumber = (link) => {
  ...
  router.visit("/quality-controls.listInProgress?page=" + pageNumber.value, {
    preserveScroll: true,
  });
      ...
      if (result.isConfirmed) {
        axios.delete(route('quality-controls.destroy', id), { data: {} })
          .then(response => {
            ...
            setTimeout(() => {
              router.visit(route('quality-controls.listInProgress'), {
                preserveScroll: true,
                replace: true
              });
            }, 1000);
    ...
    <div class="content-wrapper">
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h3 class="m-0"><strong>Quality Controls - In Progress</strong></h3>
            </div>
            <div class="col-sm-6">
