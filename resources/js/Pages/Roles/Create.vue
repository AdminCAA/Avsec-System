...
function createRole() {
    ...
    axios.post(route('roles.store'), {
        ...
        permissions: selectedPermissions.value // Get the selected permission IDs
    })
    .then(response => {
        Swal.fire({
            icon: "success",
...
<template>
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Roles/Create</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><Link class="btn btn-info" :href="route('roles.index')"><i class="fas fa-arrow-left"></i> Back</Link></li>
            </ol>
          </div>
        </div>
      </div>
