          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                  <table v-if="roles.data.length > 0" id="example2"
                    ...
                    <tbody>
                      <tr v-for="(role, index) in sortedRoles" :key="role.id"
                        :class="{ 'table table-selected': selectedRowId === role.id }" @click="selectRow(role.id)">
                        <td>{{ (roles.current_page - 1) * roles.per_page + index + 1 }}</td>
                        <td class="text-center">
                          <Link :href="route('roles.edit', role.id)">{{ role.name }}</Link>
                        </td>
