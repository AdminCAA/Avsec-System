...
function createProtocolQuestion() {
  ...
  axios.post(route('protocolquestions.store'), form)
    .then(() => {
      Swal.fire({
        icon: 'success',
        title: 'Protocol Question created successfully',
        toast: true,
        position: 'top-end',
        timer: 1500,
        showConfirmButton: false
...
<template>
  <Head title="Create Protocol Question" />
  <AuthenticatedLayout>
    <div class="content-wrapper">    
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h3 class="m-0"><strong>Protocol Question / Create</strong></h3>
                </div>                
            </div>
        </div>
        </div>
                ...
                <div class="col-md-8 mb-4">                    
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Create Protocol Question</h3>
                        </div>
                        <!-- form start -->                        
                        <form @submit.prevent="createProtocolQuestion">
                            <div class="card-body">
                              <!-- Name -->
                               <!-- Row 1: Name & Category -->
                                <div class="row">
                            ...
                            <div class="card-footer d-flex justify-content-end">
                              ...
                              <Link :href="route('protocolquestions.index')" class="btn btn-secondary">
