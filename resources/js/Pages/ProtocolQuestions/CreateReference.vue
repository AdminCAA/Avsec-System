...
function createProtocolQuestionReference() {
  ...
  axios.post(route('protocolquestions.storeReference', protocolQuestion.id), formData)
    .then(() => {
      Swal.fire({
        icon: 'success',
...
<template>
  <Head title="Create Protocol Reference" />
  <AuthenticatedLayout>
    <div class="content-wrapper">    
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h3 class="m-0"><strong>Protocol Reference / Create</strong></h3>
                </div>                
            </div>
        </div>
        </div>
                ...
                <div class="col-md-8 mb-4">                    
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Create Protocol Reference</h3>
                        </div>
                        <!-- form start -->                        
                        <form @submit.prevent="createProtocolQuestionReference" enctype="multipart/form-data" >
                            <div class="card-body">
                              <!-- Name -->
                               <!-- Row 1: Name & Category -->
                                <div class="row">
