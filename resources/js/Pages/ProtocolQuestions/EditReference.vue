...
const { referenceDocument } = defineProps({
    referenceDocument: {
    type: Object,
    required: true
  },
...
const form = useForm({
    ...
    protocol_question_id: referenceDocument.protocol_question_id || '',  
    doc_page: referenceDocument.doc_page || '',                
    attachment: null,    
});
...
function updateProtocolQuestionReference() {
    ...
    formData.append('protocol_question_id', referenceDocument.protocol_question_id);        
    // Append attachement file if present
    if (form.attachment) {
        formData.append('attachment', form.attachment);
    }
    // Submit the form data using Axios    
    axios.post(route('protocolquestions.updateReference', referenceDocument.id), formData)
        .then(() => {
            Swal.fire({
                icon: 'success',
                title: 'Protocol Question Reference created successfully',
                toast: true,
                position: 'top-end',
                timer: 1500,
                showConfirmButton: false
        ...
        setTimeout(() => {
            router.visit(route('protocolquestions.edit',  referenceDocument.protocol_question_id));
        }, 1500);
        }).catch(error => {        
...
<template>
  <Head title="Edit Protocol Reference" />
  <AuthenticatedLayout>
    <div class="content-wrapper">    
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h3 class="m-0"><strong>Protocol Question Reference / Edit</strong></h3>
                </div>                
            </div>
        </div>
        </div>
                ...
                <div class="col-md-8 mb-4">                    
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Edit Protocol Question Reference</h3>
                        </div>
                        <!-- form start -->                        
                        <form @submit.prevent="updateProtocolQuestionReference" enctype="multipart/form-data" >
                            <div class="card-body">
                              <!-- Name -->
                               <!-- Row 1: Name & Category -->
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                                    ...
                                                    <a href="#" class="text-decoration-none d-flex align-items-center gap-2" @click.prevent="openDocument(evidenceDocument)">
                                                    <i class="fas fa-folder-open text-warning"></i> 
                                                    <span style="margin-left: 4px;"> {{ referenceDocument.name }}</span>
                                                  </a>
                            ...
                            <div class="card-footer d-flex justify-content-end">
                              ...
                              <Link :href="route('protocolquestions.edit', referenceDocument.protocol_question_id)" class="btn btn-secondary">
