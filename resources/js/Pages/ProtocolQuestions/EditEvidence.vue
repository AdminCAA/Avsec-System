...
const { evidenceDocument } = defineProps({
  evidenceDocument: {
    type: Object,
    required: true
  },
...
const form = useForm({
    ...
    protocol_question_id: evidenceDocument.protocol_question_id || '',  
    doc_page: evidenceDocument.doc_page || '',                
    attachment: null,    
});
...
function updateProtocolQuestionEvidence() {
    ...
    formData.append('protocol_question_id', evidenceDocument.protocol_question_id);        
    // Append attachement file if present
    if (form.attachment) {
        formData.append('attachment', form.attachment);
    }
    // Submit the form data using Axios    
    axios.post(route('protocolquestions.updateEvidence', evidenceDocument.id), formData)
        .then(() => {
            Swal.fire({
                icon: 'success',
        ...
        setTimeout(() => {
            router.visit(route('protocolquestions.edit',  evidenceDocument.protocol_question_id));
        }, 1500);
        }).catch(error => {        
...
<template>
  <Head title="Edit Protocol Evidence" />
  <AuthenticatedLayout>
    <div class="content-wrapper">    
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h3 class="m-0"><strong>Protocol Question Evidence / Edit</strong></h3>
                </div>                
            </div>
        </div>
        </div>
                ...
                <div class="col-md-8 mb-4">                    
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Edit Protocol Evidence</h3>
                        </div>
                        <!-- form start -->                        
                        <form @submit.prevent="updateProtocolQuestionEvidence" enctype="multipart/form-data" >
                            <div class="card-body">
                              <!-- Name -->
                               <!-- Row 1: Name & Category -->
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                                    ...
                                                    <span style="margin-left: 4px;"> {{ evidenceDocument.name }}</span>
                                                  </a>
                            ...
                            <div class="card-footer d-flex justify-content-end">
                              ...
                              <Link :href="route('protocolquestions.edit', evidenceDocument.protocol_question_id)" class="btn btn-secondary">
