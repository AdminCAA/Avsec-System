        ...
        <div class="content-wrapper">
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <h4>
                                ...
                                <Link :href="route('quality-controls.edit', qualityControl.id)"> <strong>{{
                                    qualityControl.title }}</strong> - <strong>{{ qualityControl.control_type
                                    }}</strong> </Link>
                            </h4>
                        </div>
                    </div>
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h4 class="m-0"><strong>Update Quality Control Question</strong></h4>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item">
                                    <Link class="btn btn-info" :href="route('securityconcerns.index')"><i
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        <div class="form-group col-md-6">
                                                                            ...
                                                                            <select v-model="form.question_response"
                                                                            ...
                                                                            <small v-if="formErrors.question_response"
                                                                                class="text-danger">{{
                                                                                    formErrors.question_response }}</small>
                                                                        </div>

                                                                        <div class="form-group col-md-6">
                                                                            <label>Finding /Observation</label>
                                                                            <textarea v-model="form.finding_observation
                                                                                " class="form-control" rows="2"
                                                                                placeholder="Findings/Observation"
                                                                                :class="{
                                                                                    'is-invalid': formErrors.finding_observation,
                                                                                    'is-valid': form.finding_observation && !formErrors.finding_observation
                                                                                }">
                                                </textarea>
                                                                            <small v-if="formErrors.finding_observation"
                                                                                class="text-danger">{{
                                                                                    formErrors.finding_observation
                                                                                }}</small>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="form-group col-md-6">
                                                                            ...
                                                                            <select v-model="form.finding_category"
                                                                                ...
                                                                                <option value="">-- Select Finding
                                                                                    Category --</option>
                                                                                <option
                                                                                    v-for="item in findingCategoryOptions"
                                                                                    :key="item.id" :value="item.option">
                                                                                    {{ item.option }}</option>
                                                                            </select>
                                                                            <small v-if="formErrors.finding_category"
                                                                                class="text-danger">{{
                                                                                    formErrors.finding_category }}</small>
                                                                        </div>

                                                                        <div class="form-group col-md-6">
                                                                            <label>Date of Quality Control</label>
                                                                            <input v-model="form.date_quality_control"
                                                                                type="date" class="form-control" :class="{
                                                                            ...
                                                                            <small
                                                                                v-if="formErrors.date_quality_control"
                                                                                class="text-danger">{{
                                                                                    formErrors.date_quality_control
                                                                                }}</small>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="form-group col-md-6">
                                                                            ...
                                                                            <select
                                                                                v-model="form.proposed_follow_up_action"
                                                                                class="form-control" :class="{
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="form-group col-md-6">
                                                                            <label
                                                                                v-if="!question.evidence_file">Evidence
                                                                                Attachment</label>
                                                                            <a v-if="question.evidence_file"
                                                                                ...
                                                                                target="_blank">
                                                                                <i class="fas fa-paperclip"></i><span><label>Evidence
                                                                            ...
                                                                            <small v-if="formErrors.evidence_file"
                                                                                class="text-danger">{{
                                                                                    formErrors.evidence_file }}</small>
                                                                        </div>
                                                                        <div class="form-group col-md-6">
                                                                            <label>Status</label>
                                                                    ...
                                                                    <div class="card card-info collapsed-card">
                                                                        <div class="card-header">
                                                                            <h3 style="font-weight: bold;"
                                                                                class="card-title"
                                                                                data-card-widget="collapse">Corrective
                                                                                Action Plan</h3>
                                                                        ...
                                                                        <div class="card-body">
                                                                            <div class="row">
                                                                                <div class="form-group col-md-6">
                                                                                    <label v-if="!question.cap_file">CAP
                                                                                        Attachment</label>
                                                                                    <a v-if="question.cap_file"
                                                                                        ...
                                                                                        target="_blank">
                                                                                        <i
                                                                                            class="fas fa-paperclip"></i><span><label>CAP
                                                                                                Attachment</label>
                                                                                        </span>
                                                                                    </a>
                                                                                    <div class="input-group">
                                                                                    ...
                                                                                    <small v-if="formErrors.cap_file"
                                                                                        class="text-danger">{{
                                                                                            formErrors.cap_file }}</small>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <div class="card card-info collapsed-card">
                                                                        <div class="card-header">
                                                                            <h3 style="font-weight: bold;"
                                                                                ...
                                                                                Follow-Ups <span
                                                                                    class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-warning ml-1">
                                                                                    {{ followups.length }}
                                                                        ...
                                                                        <div class="card-body">
                                                                            <div
                                                                                ...
                                                                                <Link
                                                                                    :href="route('followups.create', question.id)"
                                                                                ...
                                                                                <table id="example2"
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr v-for="(followup, index) in followups"
                                                                                            ...
                                                                                            <td class="text-center">{{
                                                                                                followup.followup_comments
                                                                                            }}</td>


                                                                                            <td class="text-center">
                                                                                                {{
                                                                                                dayjs(followup.followup_date).format('DD-MM-YYYY')
                                                                                                }}
                                                                                            </td>
                                                                                            <td class="text-center">
                                                                                                {{ followup.user_name }}
                                                    ...
                                                    <textarea v-model="form.reason_for_rejection" class="form-control"  placeholder="Reason for Rejecting CAP">
                                                                    ...
                                                                    <div class="d-flex justify-content-end">
                                                                        <button :disabled="isLoading" type="submit"
                                                                            class="btn btn-info mr-0">
                                                                            <span v-if="isLoading"><i
                                                                                    class="fas fa-spinner fa-spin"></i>
                                                                                Saving...</span>
                                                                            <span v-else><i class="fas fa-save"></i>
                                                                                Save</span>
                                                                        </button>
                                                                    </div>
                                                                </div>
