    ...
    <div class="content-wrapper">
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h3 class="m-0"><strong>Security Concerns</strong></h3>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="card">
                <div class="card-body">
                      ...
                      <div class="form-group">
                        <div class="input-group input-group-sm">
                          <input type="search" class="form-control form-control-lg"
                            placeholder="Search for Security Concern here.." v-model="search">
                  ...
                  <table id="example2" class="table table-sm table-bordered table-hover table-striped">
                    ...
                    <tbody>
                      <tr v-for="(securityConcern, index) in sortedQuestionsWithConcerns" :key="securityConcern.id"
                        ...
                        <td>{{ (questionsWithConcerns.current_page - 1) * questionsWithConcerns.per_page + index + 1 }}
                        </td>
                        ...
                        <td>
                          <Link :href="route('quality-controls.edit', securityConcern.quality_control_id)">{{
                            securityConcern.quality_control.title }}</Link>
                        </td>
                        ...
                        <td>
                          <div class="d-flex justify-content-center">
                            <Link class="btn btn-success btn-sm mr-2"
                              :href="route('securityconcerns.edit', securityConcern.id)">
                  ...
                  <div v-else class="card mt-3">
                    <h3>No Security Concern found</h3>
                  </div>
                </div>
              </div>
            </div>
