...
<template>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="#" class="brand-link">
            <img :src="logoImage" alt="Civil Aviation Authority Logo" class="brand-image img-circle elevation-3"
                style="opacity: .8">
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item">
                        <Link :href="route('facilities.index')" class="nav-link"
                    ...
                    <li class="nav-item">
                        <Link :href="route('quality-controls.index')" class="nav-link"
                    ...
                    <li class="nav-item">
                        <Link :href="route('securityconcerns.index')" class="nav-link"
                    ...
                    <li class="nav-item">
                        <Link :href="route('logout')" class="nav-link" as="button" method="post">
